...
def handle(client):
    ...
    df_dps_24_1 = (
        client.time_series.data.retrieve_latest(
            external_id=data["productionhours1"], before=time_local - relativedelta(months=1)
        )
        .to_pandas()
        .iloc[0, 0]
    )
    ...
    df_dps_24_2 = (
        client.time_series.data.retrieve_latest(
            external_id=data["productionhours2"], before=time_local - relativedelta(months=1)
        )
        .to_pandas()
        .iloc[0, 0]
    )
    ...
    df_dps_24_3 = (
        client.time_series.data.retrieve_latest(
            external_id=data["productionhours3"], before=time_local - relativedelta(months=1)
        )
        .to_pandas()
        .iloc[0, 0]
    )
    ...
    df_dps_24_4 = (
        client.time_series.data.retrieve_latest(
            external_id=data["productionhours4"], before=time_local - relativedelta(months=1)
        )
        .to_pandas()
        .iloc[0, 0]
    )
